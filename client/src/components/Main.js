...
import UnitTraceView from './View/UnitTraceView';
import ProcessTraceView from './View/ProcessTraceView';
import ProcessMonitorView from './View/ProcessMonitorView';
import WeightVerifyView from './View/WeightVerifyView';
import DistributionFlowView from './View/DistributionFlowView';
    ...
    <Router>
      <div className={classes.main}>
        <Switch>
          ...
          />
          <Route path="/trace/unit" render={() => <UnitTraceView />} />
          <Route path="/trace/process" render={() => <ProcessTraceView />} />
          <Route path="/trace/monitor" render={() => <ProcessMonitorView />} />
          <Route path="/trace/verify" render={() => <WeightVerifyView />} />
          <Route path="/trace/flow" render={() => <DistributionFlowView />} />
