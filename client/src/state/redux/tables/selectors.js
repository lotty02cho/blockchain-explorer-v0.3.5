...
export const bcAuthSelector = state => state.tables.bcAuth.rows;
export const processTraceSelector = state => state.tables.processTrace.rows;
export const processMonitorSelector = state => state.tables.processMonitor.rows;
export const weightVerifySelector = state => state.tables.weightVerify.rows;
